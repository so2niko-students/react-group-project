    ...
    public class ApplicationDbContext : DbContext, IDataBaseContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(
               new User { Id = 1, Login = "viktor", Name = "Viktor", SurName = "Ponomarenko", UserGroupId = 1 },
               new User { Id = 2, Login = "olena", Name = "Olena", SurName = "Thomas", UserGroupId = 2 }
            );
            ...
            new PostItem
            {
                ...
                ImageLink = "images/postItems/img1.jpg"
            },
            new PostItem
            {
                Id = 2,
                ...
                CreatorId = 1,
                CreateDateTime = DateTime.Now,
                ImageLink = "images/postItems/img2.jpg"
            },
            new PostItem
            {
                Id = 3,
                ...
                CreatorId = 2,
                CreateDateTime = DateTime.Now,
                ImageLink = "images/postItems/img3.png"
            },
            new PostItem
            {
                Id = 4,
                ...
                CreatorId = 2,
                CreateDateTime = DateTime.Now,
                ImageLink = "images/postItems/img4.png"
            }
            );
        }
    }
