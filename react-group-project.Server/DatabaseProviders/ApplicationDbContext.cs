    ...
    public class ApplicationDbContext : DbContext, IDataBaseContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            new PostItem
            {
                ...
                ImageLink = "https://localhost:7281/images/postItems/img1.jpg"
            },
            new PostItem
            {
                Id = 2,
                ...
                CreatorId = 1,
                CreateDateTime = DateTime.Now,
                ImageLink = "https://localhost:7281/images/postItems/img2.jpg"
            },
            new PostItem
            {
                Id = 3,
                ...
                CreatorId = 2,
                CreateDateTime = DateTime.Now,
                ImageLink = "https://localhost:7281/images/postItems/img3.png"
            },
            new PostItem
            {
                Id = 4,
                ...
                CreatorId = 2,
                CreateDateTime = DateTime.Now,
                ImageLink = "https://localhost:7281/images/postItems/img4.png"
            }
            );
        }
    }
